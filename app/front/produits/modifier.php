        ...
        <form method="POST">
            ...
            <label class="block mt-4 text-sm">
                ...
                <select type="text" name="id_categorie"  class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                    ...
                    <?php foreach ($categories as $categorie) { ?>
                        <option value="<?= $categorie->id ?? '' ?>" <?= $categorie->id === ($produit->id_categorie ?? null) ? 'selected' : '' ?> >
            ...
            <div class="flex flex-col flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
                ...
                <label class="block text-sm">
                    ...
                    <input type="number" step=".01" name="prix" value="<?= $produit->prix ?? '' ?>"  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                </label>
            </div>
